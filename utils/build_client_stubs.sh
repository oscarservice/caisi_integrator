...
mvn install:install-file -DgroupId=org.oscarehr.caisi_integrator -DartifactId=caisi_integrator_client_stubs -Dversion=0.8 -Dpackaging=jar -Dfile=../target/caisi_integrator_client_stubs.jar -DcreateChecksum=true -DgeneratePom=true 
